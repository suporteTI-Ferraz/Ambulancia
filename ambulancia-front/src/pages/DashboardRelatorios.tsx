  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="reports-grid">
        ...
        <Link to="/relatorios/manutencao" className="report-card invalid">
          <h2>Relatório de Manutenção de Veículos</h2>
          <p>Confira as manutenções realizadas nos veículos.</p>
        </Link>
        <Link to="/relatorios/pecas" className="report-card invalid">
          <h2>Relatório de Peças de Manutenção</h2>
          <p>Acompanhe o uso e estoque de peças utilizadas nas manutenções.</p>
        </Link>
        <Link to="/relatorios/fornecedores" className="report-card invalid">
          <h2>Relatório de Fornecedores de Manutenção</h2>
          <p>Visualize informações sobre os fornecedores de manutenção.</p>
        </Link>
